...
import maps from "../img/maps/maps.png";

const Footer = ({ socialsInfo }) => {
  return (
    <div className="mx-auto container bg-white xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
    <div className="flex flex-col items-center justify-center">
      <Link href="/">
        ...
        <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
            <Link href="/About">
            <p className="hover:text-gray-600 text-base cursor-pointer leading-4 text-gray-800">
              About.
            </p>
            </Link>
            <Link href="/Contact">
        ...
        <div className="flex items-center gap-x-8 mt-6">
          ...
          <Link href={socialsInfo.instagram} rel="noopener noreferrer" target="_blank">
            <div className="cursor-pointer">
          ...
          <Link href={socialsInfo.twitter} rel="noopener noreferrer" target="_blank">
            <div className="cursor-pointer">
            <svg
        ...
        <Link href="https://goo.gl/maps/qU5kZbBZppMrweDLA" rel="noopener noreferrer" target="_blank">
          <div className="flex justify-center my-10 cursor-pointer">
                <div className="flex items-center border w-auto rounded-lg px-4 py-2 w-52 mx-2">
                    <Image 
                    src={maps} 
        ...
        <div className="flex items-center mt-6">
            <p className="text-base leading-4 text-gray-800">
                2023. <span className="font-semibold">Millimag Eatery.</span>
            </p>
            <div className="border-l border-gray-800 pl-2 ml-2">
                <p className="text-base leading-4 text-gray-800">The eatery of your choice. All rights reserved</p>
            </div>
        </div>
    </div>
</div>
